      ...
      <div class="container">
        <div class="nav-left">
          <router-link to="/" class="nav-item" :class="{'hide': isOpenedInIFrame}">
            <img src="/static/app-logo.png" class="app-logo" /> <p class="app-logo-name">Cryptool<span></span></p>
          </router-link>
        </div>
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            <div class="content">
              ...
              <p>Cryptool is a real-time dashboard that displays the top 10 cryptocurrencies based on currency price, market capitalization and overall circulating supply - obtained from the leading cryptocurrency resource <a href="https://coinmarketcap.com/" target="_blank">CoinMarketCap</a>.</p>
              
              <p style="padding-bottom: 10px">Styling of the application was done with Bulma (Flexbox based CSS framework) and SASS. </p>
            </div>
          </section>
          <footer class="modal-card-foot">
            <div class="content has-text-centered">
              <div class="footer-title">Rayyan Mahar | <icon name="calendar" height="12"></icon> 2018</div>
              <div class="footer-social-media">
              
                <a class="icon" href="https://github.com/ramahar" target="_blank">
                  <icon name="github-square" scale="2"></icon>
                </a>
                 <a class="icon" href="https://www.linkedin.com/in/rayyan-mahar-1b4780106/" target="_blank">
                  <icon name="linkedin-square" scale="2"></icon>
                </a>
                <a class="icon" href="mailto:rayyanamahar@gmail.com" target="_blank">
